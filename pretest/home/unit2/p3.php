...
<head>
    ...
    <title>นอกมลของ Social Engineering</title>
...
<body>
    ...
    <footer class="footer-buttons">
        <button class="back-button" onclick="window.location.href='p2.php'">back</button>
        <button class="next-button" onclick="window.location.href='p4.php'">next</button>
    </footer>
</body>
</html>